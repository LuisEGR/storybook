...
If you are using svelte's feature **\<slot\>**, this tutorial will not work for you since slots are not supported with this syntax, to write your stories you will need to use [addon-svelte-csf]([../api/csf.md](https://github.com/storybookjs/addon-svelte-csf))  which lets you write your stories in .svelte syntax and it does supports slots. 
